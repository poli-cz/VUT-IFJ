...
#define STACK_DEFAULT 1000
  ...
  // definice typů které se vyskytují v precedenční syntaktické analýze
typedef enum{
  plus, //0
  minus, //1
  mul, //2
...
typedef enum{
  ...
  // položka na zásobníku použitém v PSA
typedef struct psateminal{
  ...
  // proměnné nutné ke korektnímu generování kodu v souboru codegen.c
  char *name;
  char *full_name;
  int lvl;
...
// Funkce nutné pro precedenční analýzu
