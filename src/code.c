...
printf("  TYPE LF@check $return");
printf("  JMPIFNEQ  inputs_error LF@check string@string");
printf("  MOVE GF@$$retval0 LF@$return\n");
printf("  MOVE GF@$$retval1 int@0\n");
printf("  JMP inputs_end");
...
printf("  TYPE LF@checki $return");
printf("  JMPIFNEQ  inputi_error LF@check string@int");
printf("  MOVE GF@$$retval0 LF@$return\n");
printf("  MOVE GF@$$retval1 int@0\n");
printf("  JMP inputi_end");
...
printf("  TYPE LF@checkf $return");
printf("  JMPIFNEQ  inputf_error LF@check string@float");
printf("  MOVE GF@$$retval0 LF@$return\n");
printf("  MOVE GF@$$retval1 int@0\n");
printf("  JMP inputf_end");
